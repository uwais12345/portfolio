...
const Chatbot = () => {
    ...
    const [messages, setMessages] = useState([
        { text: "Hi there! 👋 Welcome to Mohamed Uwais's portfolio. I'm his virtual assistant. Feel free to ask about his skills, projects, experience, or contact details!", isBot: true }
    ]);
    const [input, setInput] = useState("");
    const messagesEndRef = useRef(null);

    // Auto-open chatbot with welcome message on site load
    useEffect(() => {
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 w-[calc(100vw-3rem)] sm:w-96 mb-4 overflow-hidden flex flex-col h-[28rem]"
                    >
                        {/* Header */}
