                            ...
                            <div className="flex items-center gap-3 sm:gap-4 overflow-x-auto py-2 text-sm font-semibold [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                                {navLinks.map((link) => (
                                    <a
                                        ...
                                        className="text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 whitespace-nowrap transition-colors px-1"
                                    >
                                        {link.name}
                                    </a>
                                ))}
                        ...
                        <>
                            ...
                            <div className="md:hidden flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="p-3 rounded-md text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
